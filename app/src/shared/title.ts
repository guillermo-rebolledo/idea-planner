...
/**
 * Deterministic, local title for a Session, derived from the message that
 * started it. No AI involvement: first meaningful line, markdown markers
 * stripped, trimmed to a word boundary.
 */
